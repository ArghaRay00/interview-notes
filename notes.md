- **Study guide:**
  ...
  - Data Engineering:
    - SQL:
      ...
      - "SELECT * FROM a LEFT OUTER JOIN b ON [a.id](http://a.id/) = b.a_id WHERE b IS NULL;" gets you the records that are *only* in table a; the null part excludes the right-hand table's records / matching records are excluded
  ...
  - System Design & Distributed Systems:
    ...
    - Numbers every programmer should know about latency, memory, etc.:
      ...
      - [http://highscalability.com/blog/2013/1/15/more-numbers-every-awesome-programmer-must-know.html](http://highscalability.com/blog/2013/1/15/more-numbers-every-awesome-programmer-must-know.html)
